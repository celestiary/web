...
export default class ControlPanel {
    ...
    showNavDisplay(path) {
        ...
        html += this.showInfoRecursive(this.loader.loaded[this.getPathTarget(path)], pathPrefix, false, false);
        html += '</ul>\n';
        ...
        for (const prop in obj) {
            ...
            if (Object.prototype.hasOwnProperty.call(prop, obj)) {
                ...
                if (!isArray) {
                    let prettyName = prop;
                    switch (prop) {
                        case 'axialInclination':
                            prettyName = 'tilt';
                            break;
                        case 'siderealRotationPeriod':
                            prettyName = 'rotation period';
                            break;
                        case 'spectralType':
                            prettyName = 'star class';
                            break;
                        default:
                    }
                    html += `${prettyName}: `;
