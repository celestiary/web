...
export default class AtmosphereObject3D extends Mesh {
    ...
    onBeforeRender() {
        ...
        u.uRayleighScatteringCoeff.value.set(atmos.RayleighRed, atmos.RayleighGreen, atmos.RayleighBlue);
    ...
    return new ShaderMaterial({
        uniforms: {
            ...
            uRayleighScatteringCoeff: {
                value: new Vector3(atmos.RayleighRed, atmos.RayleighGreen, atmos.RayleighBlue),
            },
