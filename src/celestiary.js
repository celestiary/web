...
export default class Celestiary {
  ...
  load() {
    ...
    this.onDoneCb = (path, obj) => {
      ...
      setTimeout(() => {
          ...
          this.scene.lookAtNamed(parts[parts.length - 1]);
          this.scene.goTo();
        }, 0);
    };
  ...
  setupListeners() {
    ...
    window.addEventListener('keypress', (e) => {
        ...
        case 48: /* 0 */ this.scene.lookAtNamed('sun'); break;
        case 49: /* 1 */ this.scene.lookAtNamed('mercury'); break;
        case 50: /* 2 */ this.scene.lookAtNamed('venus'); break;
        case 51: /* 3 */ this.scene.lookAtNamed('earth'); break;
        case 52: /* 4 */ this.scene.lookAtNamed('mars'); break;
        case 53: /* 5 */ this.scene.lookAtNamed('jupiter'); break;
        case 54: /* 6 */ this.scene.lookAtNamed('saturn'); break;
        case 55: /* 7 */ this.scene.lookAtNamed('uranus'); break;
        case 56: /* 8 */ this.scene.lookAtNamed('neptune'); break;
        case 57: /* 9 */ this.scene.lookAtNamed('pluto'); break;
